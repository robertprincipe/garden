...
const dictionary = {
  ...
  pages: {
    "not-found": {
      ...
      description:
        "Ресурс, який ви шукаєте, може бути переміщено або не є частиною Bleverse garden. Перевірте URL або перегляньте інші розділи.",
    ...
    home: {
      ...
      subtitle:
        "Bleverse garden спрощує ваш розвиток. Почніть з вбудованих функцій, оптимізованих для сучасної веб-розробки.",
      "get-started": "Почати роботу",
      features: {
        title: "Основні можливості garden",
        subtitle:
          "Від коду до дизайну, garden надає функції, які значно покращують ваші веб-проєкти.",
        cryptography: {
          title: "Next.js 13",
          description:
      ...
      "open-source": {
        ...
        subtitle: {
          first:
            "Bleverse garden підтримує дух відкритого коду та заохочує до співпраці над кодом.",
    ...
    about: {
      title: "Про нас",
      subtitle:
        "Bleverse garden - це потужний стартовий пакет для Next.js TypeScript Tailwind. Він оптимізує процес розробки та забезпечує міцну основу для створення веб-проектів. Відчувайте себе вільно використовувати, адаптувати та вносити свій вклад у проект, натиснувши {link}.",
      "subtitle.link": "тут",
      credits: {
        title: "Подяки",
        topics: {
